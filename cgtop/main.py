...
# Need to store the panel in a variable to prevent
  # Garbage collection.
  cgroup_container = CgroupContainer(start_x=stdscr.MAX_WIDTH / 3 + 1, start_y=1,
                                     width=stdscr.MAX_WIDTH / 3,
                                     height=stdscr.MAX_HEIGHT / 2)
  cgroup_container.title_window_on_screen()
  cpu_fill_bar = cgroup_container.create_cpu_fill_bar()
  ...
  # Garbage collection.
  cgroup_container = CgroupContainer(start_x=2 * stdscr.MAX_WIDTH / 3 + 1, start_y=1,
                                     width=stdscr.MAX_WIDTH / 3,
                                     height=stdscr.MAX_HEIGHT / 2)
  cgroup_container.title_window_on_screen()
  cpu_fill_bar = cgroup_container.create_cpu_fill_bar()
 ...
 # Garbage collection.
  cgroup_container = CgroupContainer(start_x=stdscr.MAX_WIDTH / 2 + 1, start_y=stdscr.MAX_HEIGHT/2 + 1,
